...
const Login = () => {
  ...
  const handleSubmission =async (data) => {
    ...
    if (res.success) {
      ...
      console.log(res.data.profile.education);
              ...
              >
                <div className="flex flex-col">
                  ...
                  <input
                    type="email"
                    id="email"
                    className={`border-2 rounded-lg h-12 focus:outline-none px-5 ${error || errors?.email?.message ? "border-red-500" : ""
                      }`}
                    {...register("email")}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    id="password"
                    className={`border-2 rounded-lg h-12 focus:outline-none px-5 ${error || errors?.password?.message ? "border-red-500" : ""
                      }`}
                    {...register("password")}
                    onChange={handleInputChange}
                    required

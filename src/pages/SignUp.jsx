...
const [linkedinSignUpUrl, setLinkedinSignUpUrl] = useState("http://localhost:5002/auth/linkedin")
  ...
  const handleWithLinkedIn = async () => {
    // Assuming you have the linkedinSignUpUrl defined somewhere
    // For example: const linkedinSignUpUrl = "/signUp/auth/linkedin";

    try {
      const response = await fetch(linkedinSignUpUrl);
      ...
      // Assuming the response contains JSON data, use response.json() to parse it
          ...
          >
            ...
            <div className="flex flex-row items-center  justify-center gap-5">
              ...
              <div onClick={() => {}} className="hover:cursor-pointer">
                <img onClick={handleWithLinkedIn}
